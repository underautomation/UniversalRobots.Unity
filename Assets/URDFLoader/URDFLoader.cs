        ...
        foreach (XmlNode jointNode in xmlJointsArray)
        {
            ...
            if (limitNode != null)
            {
                ...
                if (limitNode.Attributes["lower"] != null)
                {
                    ...
                    urdfJoint.minAngle = (float)double.Parse(limitNode.Attributes["lower"].Value, CultureInfo.InvariantCulture);
                ...
                if (limitNode.Attributes["upper"] != null)
                {
                    ...
                    urdfJoint.maxAngle = (float)double.Parse(limitNode.Attributes["upper"].Value, CultureInfo.InvariantCulture);
